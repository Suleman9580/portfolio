...
const ProjectCard = ({ title, description, link, image }) => {
  ...
  return (
    <div  className="bg-neutral-900 h-100 p-10 rounded-lg flex gap-20 card ">
      <div className="overflow-hidden  rounded-lg cursor-pointer ">
        <img
          src={image}
          alt={title}
          className=" scale-[1] hover:scale-[1.03] transition-all ease-in-out duration-300 object-cover rounded-lg"
        />
      </div>
